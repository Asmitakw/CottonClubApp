        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (etUserId.getText().toString().equals(Constants.ADMIN)
                        ...
                        || etUserId.getText().toString().equals(Constants.RECEIVING_IN_CHARGE_KM)
                        || etUserId.getText().toString().equals(Constants.RECEIVING_IN_CHARGE_BB)
                        || etUserId.getText().toString().equals(Constants.RECEIVING_IN_CHARGE_CB)
