...
public class CustomEditViewRegular extends AppCompatEditText
{
	private Typeface tf;
	public  final String DEFAULT_FONT = "fonts/calibri.ttf";
	public CustomEditViewRegular(Context context)
	{
		super(context);
		if (!isInEditMode())
			init(null);
	}
	public CustomEditViewRegular(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		if (!isInEditMode())
			init(attrs);
	...
	public CustomEditViewRegular(Context context, AttributeSet attrs, int defStyle)
	{
